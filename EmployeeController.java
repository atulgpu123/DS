...
import in.bushansirgur.restapi.dao.BankDAO;
...
public class EmployeeController {
	...
	@GetMapping("/read")
	public List<BankModel> read(){
		List<BankModel> bankModel = bankDAO.findAll();
		seqGeneratorService.processRegexList(bankModel);
